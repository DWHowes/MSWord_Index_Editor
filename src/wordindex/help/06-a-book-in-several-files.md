...
- **One index across the whole project.** The list on the right shows every
  entry in every document. Clicking one from a chapter you are not looking at
  switches to that chapter.
...
**Index > Save entries** writes every document that changed. If one cannot be
written the others still are, and you are told which by name.
